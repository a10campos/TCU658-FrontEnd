...
export default function Footer () {
    ...
    return (
        ...
        <>
        <footer className="mt-2 h-32 lg:h-20 bg-gray border flex flex-wrap p-7 items-center justify-center ">
                <div className="">
                    <div className="pl-2 grid grid-cols-1 lg:flex lg:flex-row lg:space-x-80">
                        <div className="flex "> 
                            <AiFillMail className="m-1 "></AiFillMail>
                            <span className="text-lg">tcu658ELM@ucr.ac.cr</span>
                        </div>
                        <div className="flex">
                            <AiFillPhone className="m-1"></AiFillPhone>
